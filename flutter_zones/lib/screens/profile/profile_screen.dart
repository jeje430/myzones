...
import '../drawer/points_rewards_screen.dart';
...
class _ProfileScreenState extends State<ProfileScreen> {
                      ...
                      : SingleChildScrollView(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              _buildIdentityCard(context, onSurface, user.name),
                              ...
                              _buildSettingsSection(context, themeProvider, onSurface, isDark),
    ...
    return GestureDetector(
      ...
      onTap: () {
        ...
        Navigator.push(
          ...
          MaterialPageRoute(builder: (_) => const PointsRewardsScreen()),
          ...
          children: [
            ...
            Row(
              ...
              children: [
                ...
                Icon(Icons.chevron_left, color: ZonezColors.textMuted, size: 20),
  ...
  Widget _buildIdentityCard(BuildContext context, Color onSurface, String name) {
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      ...
                      themeProvider.isDark ? 'الوضع الداكن' : 'الوضع الفاتح',
