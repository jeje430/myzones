          ...
          ListView(
            ...
            children: [
              _SectionCard(
                ...
                onSurface: onSurface,
                rules: const [
                  'يجب تأكيد الحجز خلال 15 دقيقة من اختيار الموعد.',
                  'يمكن إلغاء الحجز مجاناً قبل 3 ساعات من الموعد المحدد.',
                  'في حال التأخر أكثر من 15 دقيقة، قد يُلغى الحجز تلقائياً.',
                  'لا يُسمح بتحويل الحجز لشخص آخر دون إشعار الصالة.',
                ],
              ),
