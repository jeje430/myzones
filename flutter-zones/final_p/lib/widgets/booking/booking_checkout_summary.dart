    ...
    return Column(
      ...
      children: [
        ...
        if (canPayWithPoints) ...[
          ...
          _MethodTile(
            title: 'دفع بالنقاط',
            subtitle: 'حجز مجاني — شريط النقاط مكتمل',
            icon: Icons.stars_rounded,
            selected: selected == PaymentStatus.payWithPoints,
            onTap: () => onChanged(PaymentStatus.payWithPoints),
            accentColor: ZonezColors.neonGold,
          ),
        ],
      ],
    );
...
class _MethodTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final isDark = Theme.of(context).brightness == Brightness.dark;
    final accent = accentColor ?? ZonezColors.neonPurple;
        ...
        child: Container(
          ...
          child: Row(
            children: [
              Icon(
                icon,
                color: selected ? accent : ZonezColors.textMuted,
              ),
