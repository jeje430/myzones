...
export default function FinanceRevenuesPanel() {
  ...
  const series = useMemo(() => buildRevenueSeries(year, month, granularity), [year, month, granularity, readyTick]);
  const totals = useMemo(() => deriveRevenueTotals(year, month), [year, month, readyTick]);
  const insights = useMemo(() => deriveRevenueInsights(series, granularity), [series, granularity]);
  const categories = useMemo(() => buildCategoryBreakdown(year, month), [year, month, readyTick]);
  ...
  return (
    <div className="revenues-page" dir="rtl">
      ...
      <div className="revenues-kpi-grid">
        ...
        <article className="finance-card finance-card--blue">
          <div className="finance-card__top">
            <span className="finance-card__label">متوسط الإيراد اليومي</span>
          </div>
        ...
        <article className="finance-card finance-card--blue">
          <div className="finance-card__top">
            <span className="finance-card__label">أعلى يوم إيراد</span>
            <span className="finance-card__icon finance-card__icon--blue" aria-hidden>
        ...
        <article className="finance-card finance-card--blue">
          <div className="finance-card__top">
            <span className="finance-card__label">أقل يوم إيراد</span>
            <span className="finance-card__icon finance-card__icon--blue" aria-hidden>
      ...
      <div className="revenues-charts">
        <section className="revenues-chart-panel">
          <h2 className="revenues-chart-panel__title">الإيرادات اليومية</h2>
          <div className="revenues-line-wrap">
            <ResponsiveContainer width="100%" height="100%">
              <LineChart data={series} margin={{ top: 8, right: 8, left: 4, bottom: 4 }}>
                ...
                <Line type="monotone" dataKey="revenue" stroke="#22d3ee" strokeWidth={2.6} dot={false} activeDot={{ r: 4, fill: "#22d3ee" }} />
              </LineChart>
            </ResponsiveContainer>
          </div>
        </section>
        <section className="revenues-chart-panel">
          <h2 className="revenues-chart-panel__title">توزيع الإيرادات حسب الفئة</h2>
      ...
      <p className="revenues-footnote">يتم تحديث بيانات الإيرادات تلقائيًا بناءً على الحجوزات والمدفوعات المسجلة داخل النظام.</p>
    </div>
  );
}
